...
<li> <a class="Account" href="signup.php" style="color:black;" > <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
...
<br><br>
<li><a href="Shop Telephones.php"class="underMenuS" style="color:darkorchid;font-family: Bahnschrift;"> Телефоны</a></li>
<li><a href="Shop Noyts.php" class="underMenuS" style="color:darkorchid;font-family: Bahnschrift;"> Ноутбуки</a></li>
<li><a href="Shop Kotli.php" style="color:darkorchid;font-family: Bahnschrift;" class="underMenuS"> Часы</a></li>
<li><a href="Shop Tablets.php" class="underMenuS" style="color:darkorchid;font-family: Bahnschrift;"> Планшеты</a></li>
<li><a href="Shop Accessories.php" style="color:darkorchid;font-family: Bahnschrift;" class="underMenuS"> Аксессуары</a></li>
<li><a href="Shop Gadgets.php" class="underMenuS" style="color:darkorchid;font-family: Bahnschrift;"> Гаджеты</a></li>
</ul>
</div>
...
<div class="col-md-8 col-xs-12"><div class="hello" Style="font-size: 36px; margin-left: 1em; font-family: Bahnschrift; " align="center">Добро пожаловать!</div>
<div style="background-color: #fffbe9; border: 4px solid darkorchid;border-radius: 2px 2px 15px 15px;font-family: Bahnschrift;">

<h3 class="text" align="center">
    На данном сайте вы можете оформить и<br>
    купить любой товар, а мы вам в этом <br>
    поможем. Friday-и пусть шоппинг будет <br>
    для вас настоящим отдыхом!</h3></div>
...
<div class="col-auto">
<p class="pt-2">
<strong><h3>Подпишитесь на нашу рассылку</h3></strong>
</p>
</div>
...
<a href="http://localhost/reg.php" style="color:darkorchid">Личный кабинет</a>
</li>
<li>
...
<div class="col-lg-3 col-md-6 mb-4 mb-md-0">
<h5 class="text-uppercase"id="catalog">Каталог товаров</h5>
...
<path d="M4.406 3.342A5.53 5.53 0 0 1 8 2c2.69 0 4.923 2 5.166 4.579C14.758 6.804 16 8.137 16 9.773 16 11.569 14.502 13 12.687 13H3.781C1.708 13 0 11.366 0 9.318c0-1.763
 
1.266-3.223 2.942-3.593.143-.863.698-1.723 1.464-2.383zm.653.757c-.757.653-1.153 1.44-1.153 2.056v.448l-.445.049C2.064 6.805 1 7.952 1 9.318 1 10.785 2.23 12 3.781 12h8.906C13.98 12 15 10.988 15 9.773c0-1.216-1.02-2.228-2.313-2.228h-.5v-.5C12.188 4.825 10.328 3 8 3a4.53 4.53 0 0 0-2.941 1.1z"/>
</svg></a>
</li>
</ul>
</div>
...
else if ((document.getElementById("searchpole").value=="Гаджет") || (document.getElementById("searchpole").value=="Гаджеты")|| (document.getElementById("searchpole").value=="Умный брелок Aplle AirTag") || (document.getElementById("searchpole").value=="умный брелок aplle airtag")|| (document.getElementById("searchpole").value=="Умный брелок aplle airtag")|| (document.getElementById("searchpole").value=="Умный брелок")|| (document.getElementById("searchpole").value=="AirTag")|| (document.getElementById("searchpole").value=="Робот Robosen")|| (document.getElementById("searchpole").value=="Робот")|| (document.getElementById("searchpole").value=="Робот robosen")|| (document.getElementById("searchpole").value=="робот robosen")|| (document.getElementById("searchpole").value=="Robosen")|| (document.getElementById("searchpole").value=="robosen")|| (document.getElementById("searchpole").value=="Квадракоптер")||
 
(document.getElementById("searchpole").value=="квадракоптер")){
