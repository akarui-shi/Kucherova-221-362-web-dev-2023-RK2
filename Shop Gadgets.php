...
<body>
  ...
  <?php
	...
	*/
	...
	$rs = mysqli_query($link, "SELECT * FROM tovar WHERE type_id='6'");
	  echo"<div class='hits'>
	...
	echo "<li class='product-wrapper'>
				<a class='product'>
					<div class='product-photo'>
                    		<img class='ImgForHits' src=" .$row['foto']. ">
							</div>
						</a>
					   <p style='margin-top:-90px;color: black;text-align: center'>".$row['opisanie']."
					   </p>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
            ...
            <ul class="list-unstyled mb-0">
              ...
              <li>
                <a href="reg1.php" style="color:darkorchid">Личный кабинет</a>
              </li>
              <li>
